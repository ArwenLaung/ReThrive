              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 pr-3 py-2.5 border rounded-xl focus:ring-2 outline-none text-sm ${phone && !isPhoneValid(phone) ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-[#7db038]'
                      }`}
