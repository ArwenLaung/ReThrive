      ...
      <div className="border-b border-gray-200 bg-white sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex gap-3 mt-24">
            ...
            <button onClick={handleSearch} className="bg-brand-purple text-white px-6 py-3 rounded-2xl font-bold hover:bg-purple-500 transition-colors shadow-md">Search</button>
          </div>
